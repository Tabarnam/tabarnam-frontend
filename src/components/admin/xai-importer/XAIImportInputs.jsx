// src/components/admin/xai-importer/XAIImportInputs.jsx
    ...
    case 'product_keyword':
      return (
        <div className="bg-slate-800/50 p-6 rounded-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="bg-slate-800 border-gray-600 text-white w-full rounded-md shadow-sm p-2"
              />
            </div>
            <div>
          ...
          <p className="text-xs text-gray-400 mt-2">xAI will search for up to {maxImports} companies matching the field and value.</p>
        </div>
      );
