    ...
    <div className="border border-slate-200 dark:border-border rounded-lg bg-white dark:bg-card overflow-hidden mb-4">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-semibold text-sm text-slate-900 dark:text-foreground">Fetch Review From Link</span>
            <div className="text-[11px] text-slate-500 dark:text-muted-foreground font-normal">Paste a URL to extract structured review data</div>
          </div>
        </div>
      </button>
