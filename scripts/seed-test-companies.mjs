...
for (let i = 1; i <= 20; i++) {
  ...
  const company = {
    ...
    url: `https://test-company-${i}.example.com`,
    normalized_domain: `test-company-${i}.example.com`,
    ...
    product_keywords: `test company quality innovation reliable service keyword-${i}`,
    ...
    hq_lat: baseLocation.lat,
    hq_lng: baseLocation.lng,
    headquarters: [
      {
    ...
    headquarters_location: `${100 + i} Main St, ${baseLocation.city}`,
    manufacturing_locations: [
      ...
      },
      {
        ...
        city: locations[(locationIdx + 1) % locations.length].city,
        country: "USA",
