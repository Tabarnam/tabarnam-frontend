...
module.exports = async function adminRecentImportsLegacy(context, req) {
  try {
    ...
    context.res = {
      ...
      body: result?.body || result?.jsonBody,
    };
  } catch (e) {
    context.log("[admin-recent-imports] legacy wrapper error", e?.message || e);
    context.res = {
      status: 500,
