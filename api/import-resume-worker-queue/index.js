// Queue trigger for import resume worker - merged into api/ folder
const { app } = require("../_app");
const { resumeWorkerHandler } = require("../import/resume-worker/handler");
...
function logQueueConfigOnce() {
  ...
  try {
    ...
    console.log("[import-resume-worker-queue] queue_config", {
    ...
    console.log("[import-resume-worker-queue] queue_config_error", {
  ...
  handler: async (message, context) => {
    ...
    try {
      ...
      if (result && typeof result === "object") {
        ...
        wroteToCosmos = Boolean(body?.did_work) || Boolean(body?.resume_control_doc_upsert_ok);
      }
    } catch (e) {
