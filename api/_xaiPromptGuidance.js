...
- Return an array of up to 7 specific, descriptive industry labels that describe what the company actually manufactures or sells. Be specific to the company's niche (e.g., "Hawaiian Snack Foods" not "Food", "Artisan Beef Jerky" not "Retail", "Specialty Pet Nutrition" not "E-Commerce").
- Do NOT return generic umbrella terms like "Consumer Goods", "Food and Beverage", "Retail", "E-Commerce", "Food", "Shopping".
- Maximum 7 industries. Pick the most specific and descriptive ones.
...
Industries:
Return up to 7 specific, descriptive industry labels that describe what ${name} actually manufactures or sells.
...
Having the actual cities within the USA is crucial. Use initials for state or province. Use "USA" not "United States". No explanatory info — just locations. Also return "location_source_urls" with the URLs you actually visited to determine each location.`,
  industries: `Use web_search for industry classifications. Return a JSON array of up to 3 specific, descriptive industry strings (e.g., "Home Textiles Manufacturing", "Bedding Products"). Avoid generic umbrella terms like "Consumer Goods" or "Food and Beverage". Maximum 7 industries.`,
