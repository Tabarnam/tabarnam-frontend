...
const { toFiniteNumber, computeContractEnrichmentHealth } = require("../_contractHealth");
...
// toFiniteNumber / isValidLatLngPair / toLocationArray / pickFirstRealHqCandidate /
// resolveContractManufacturingLocations / shouldClearHqUnknown / shouldClearMfgUnknown
// moved to ../_contractHealth (imported at the top of this file).
...
// normalizeKeywordList / getContractKeywordInputs / computeContractEnrichmentHealth
// moved to ../_contractHealth (imported at the top of this file).
...
async function adminCompaniesHandler(req, context, deps = {}) {
    ...
    try {
      if (method === "GET") {
        ...
        // power the tally counters at the top of /admin/images, which need
        // the full dataset's stats regardless of the active filter view.
        ...
        // (unconditional) so existing tally callers don't break.
