// Admin save diagnostic endpoint
// Helps debug why company saves aren't persisting
...
app.http("adminSaveDiagnostic", {
  ...
  handler: async (req, context) => {
    ...
    if (method === "POST") {
      ...
      try {
        // Test 1: Try upsert with partition key
